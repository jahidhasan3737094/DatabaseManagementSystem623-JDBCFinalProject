...
public class JDBCMain {
	...
	public static void main(String[] args) {
		...
		try {
		    ...
		    connection = DriverManager.getConnection("jdbc:postgresql://localhost:5433/jdbcproject","postgres", "jahid37094");
			...
			String disableFKQuery = "ALTER TABLE Stock DROP CONSTRAINT stock_prodid_fkey;";
			...
			// Enable foreign key 
			String enableFKQuery = "ALTER TABLE Stock ADD CONSTRAINT stock_prodid_fkey FOREIGN KEY (prodid) REFERENCES Product (prodid);";
